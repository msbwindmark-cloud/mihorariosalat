"""
Django settings for adan_project_django project.
...
SECRET_KEY = 'django-insecure-#*&)*j@3za^-2mrq-641x06znki$svhfd-vnw1d6f+r4n3mn+i'
...
WSGI_APPLICATION = 'adan_project_django.wsgi.application'
